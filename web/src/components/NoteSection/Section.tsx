      ...
      <div className="container px-5 py-12 mx-auto flex flex-col">
        <div className="lg:w-4/6 mx-auto w-full">
          {idx === 0 ? (
              ...
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0">
                <div className="mb-2">
                  <Link
                    ...
                    id={subtitleId}
                  >
                    <h2 className="mb-2 font-extrabold text-2xl group-hover:text-indigo-400">
                      {section.subtitle}
                    </h2>
                ...
                <div>
                  <div
                    className="leading-relaxed text-xl mb-4 prose lg:prose-md"
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="mt-4 pt-4 sm:mt-0 w-full">
