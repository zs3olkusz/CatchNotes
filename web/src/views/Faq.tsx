                      ...
                      <ul>
                          <li className="py-6 border-gray-200 border-solid border-b">
                              <div className="flex justify-between items-center">
                                  <h3 className="text-gray-800 text-base  md:text-xl  xl:text-2xl w-10/12">What is the maximum number of notes that I can create?</h3>
                              ...
                              {question === 0 && <p className="pt-2 md:pt-3  lg:pt-5 text-gray-800 bg-gray-100 text-sm md:text-base  xl:text-lg rounded-b-lg">The maximum number of notes that you can create is unlimited. :)</p>}
                          </li>
                          <li className="py-6 border-gray-200 border-solid border-b">
                              <div className="flex justify-between items-center">
                                  <h3 className="text-gray-800 text-base  md:text-xl  xl:text-2xl w-10/12">How can I give access to my notes for my friend? </h3>
                              ...
                              {question === 1 && <p className="pt-2 md:pt-3  lg:pt-5 text-gray-800 bg-gray-100 text-sm md:text-base  xl:text-lg rounded-b-lg">You must generate an invite code and give it to your friend. Next he must just click on invitation link and thats it. :)</p>}
                          </li>
                          <li className="py-6 border-gray-200 border-solid border-b">
                              <div className="flex justify-between items-center">
                                  <h3 className="text-gray-800 text-base  md:text-xl  xl:text-2xl w-10/12">How can I change my password?</h3>
                          ...
                          <li className="py-6 border-gray-200 border-solid border-b">
                              <div className="flex justify-between items-center">
                                  <h3 className="text-gray-800 text-base  md:text-xl  xl:text-2xl w-10/12">How can I create a note?</h3>
                              ...
                              {question === 3 && <p className="pt-2 md:pt-3  lg:pt-5 text-gray-800 bg-gray-100 text-sm md:text-base  xl:text-lg rounded-b-lg">You must click on CREATE NOTE button. It is that simple :) </p>}
                          </li>
                          <li className="py-6 border-gray-200 border-solid border-b">
                              <div className="flex justify-between items-center">
                                  <h3 className="text-gray-800 text-base  md:text-xl  xl:text-2xl w-10/12">How can I delete my account?</h3>
