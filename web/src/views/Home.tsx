...
const HomeView: React.FC = () => {
      ...
      <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div className="sm:text-center lg:text-left">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-indigo-600 xl:inline">your notes</span>
          </h1>
          <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            On this website you can create notes that will help you in your future education. Learn more with your friends using our site. Have fun ! :)
          </p>
          <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div className="rounded-md shadow">
              <Link to="/notes" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white from-blue-500 via-pink-400 to-purple-500 bg-gradient-to-br hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                Notes
              </Link>
            </div>
  ...
  <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img  className="h-56 w-30% object-cover sm:h-72 md:h-96  lg:h-full" src="https://zyskiwanieprzewagi.com/wp-content/uploads/2019/10/jak-robic%CC%81-notatki-do-szko%C5%82y-lub-na-uczelnie%CC%A8-1024x683.jpg" alt=""/>
  </div>
</div>
      <Link to="/login"></Link>
    </div>
